...
import { getPluginReturn, getPluginTemplates, getPluginVariables } from "@infinite/services/api/model-plugin";
import type { ModelCapability } from "@infinite/stores/use-config-store";
