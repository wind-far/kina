...
import { type CanvasNodeData, type ViewportTransform } from "@infinite/types/canvas";
    ...
    return (
        <div className="absolute bottom-24 left-6 z-50 overflow-hidden rounded-lg border shadow-2xl backdrop-blur-sm" style={{ width, height, background: theme.toolbar.panel, borderColor: theme.toolbar.border }}>
            ...
            >
                ...
                <div className="pointer-events-none absolute border" style={{ left: viewportRect.x, top: viewportRect.y, width: viewportRect.w, height: viewportRect.h, borderColor: theme.node.activeStroke, background: `color-mix(in srgb, ${theme.node.activeStroke} 10%, transparent)` }} />
            </div>
        </div>
    );
}
