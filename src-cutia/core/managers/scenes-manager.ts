...
import {
	...
	canDeleteScene,
	findCurrentScene,
} from "@cutia/lib/scenes";
import { getFrameTime, isBookmarkAtTime } from "@cutia/lib/timeline/bookmarks";
import { ensureMainTrack } from "@cutia/lib/timeline/track-utils";
import {
	CreateSceneCommand,
	DeleteSceneCommand,
