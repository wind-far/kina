import type { AiTextMessage } from "@infinite/services/api/image";
import i18n from "@infinite/i18n";
import { imageReferenceLabel } from "@infinite/lib/image-reference-prompt";
import { seedanceReferenceLabel } from "@infinite/lib/seedance-video";
import type { ReferenceImage } from "@infinite/types/image";
import type { ReferenceAudio, ReferenceVideo } from "@infinite/types/media";
import { CanvasNodeType, type CanvasConnection, type CanvasNodeData } from "@infinite/types/canvas";
import { getGenerationResourceNodes } from "@infinite/lib/canvas/canvas-resource-references";
...
export async function hydrateNodeGenerationContext(context: NodeGenerationContext) {
    const { imageToDataUrl } = await import("@infinite/services/image-storage");
