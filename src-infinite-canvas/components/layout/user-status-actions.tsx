...
import { GitHubLink } from "@infinite/components/layout/github-link";
import { VersionReleaseModal } from "@infinite/components/layout/version-release-modal";
import { DOCS_URL } from "@infinite/constant/env";
import { changeAppLocale, type AppLocale } from "@infinite/i18n";
import { cn } from "@infinite/lib/utils";
import { canvasThemes } from "@infinite/lib/canvas-theme";
import { useConfigStore } from "@infinite/stores/use-config-store";
