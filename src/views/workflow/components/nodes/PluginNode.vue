...
<style scoped>
.wf-plugin-node { position: relative; width: 254px; padding: 15px; border: 1px solid color-mix(in srgb, var(--plugin-color) 72%, white); border-radius: 13px; background: #17171e; box-shadow: 0 12px 34px rgba(0,0,0,.22); color: #f4f4f6; }
