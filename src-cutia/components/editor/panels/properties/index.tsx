...
import type { TimelineElement, TimelineTrack } from "@cutia/types/timeline";
			...
			{selectedElements.length > 0 ? (
				<ScrollArea className="h-full">
					{grouped.text && grouped.text.length > 0 && (
						<TextProperties
							elements={grouped.text.map((item) => ({
								element: item.element as import("@cutia/types/timeline").TextElement,
					...
					{grouped.video && grouped.video.length > 0 && (
						<VideoProperties
							_element={
								grouped.video[0]
									.element as import("@cutia/types/timeline").VideoElement
							}
					...
					{grouped.image && grouped.image.length > 0 && (
						<VideoProperties
							_element={
								grouped.image[0]
									.element as import("@cutia/types/timeline").ImageElement
							}
				...
				{grouped.audio && grouped.audio.length > 0 && (
					<AudioProperties
						_element={
							grouped.audio[0]
								.element as import("@cutia/types/timeline").AudioElement
						}
				...
				{grouped.sticker && grouped.sticker.length > 0 && (
					<StickerProperties
						_element={
							grouped.sticker[0]
								.element as import("@cutia/types/timeline").StickerElement
						}
