...
import { CanvasNodeType } from "@infinite/types/canvas";
import type { CanvasNodeMetadata } from "@infinite/types/canvas";
import { getNodeSpec as getRegistryNodeSpec } from "@infinite/lib/canvas/node-registry";
