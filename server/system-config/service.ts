...
const DEFAULT_HOME_SIDE_MENU_ITEMS = [
  ...
  { key: 'workflow', title: '工作流', section: 'center', iconSource: 'default', iconType: 'system', icon: 'workflow', inactiveIconUrl: '', activeIconUrl: '', visible: true, badgeText: '', badgeTone: 'default', actionType: 'route', actionValue: '/agentic-assets-workflow', sortOrder: 50 },
