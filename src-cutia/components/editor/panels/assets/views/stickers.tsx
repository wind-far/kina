...
import { InputWithBack } from "@cutia/components/ui/input-with-back";
...
import { STICKER_CATEGORIES } from "@cutia/constants/stickers-constants";
...
import { useStickersStore } from "@cutia/stores/stickers-store";
...
function StickersContentView({ category }: { category: StickerCategory }) {
	...
	return (
		<div className="mt-1 flex h-full min-h-0 flex-col gap-5 p-4">
