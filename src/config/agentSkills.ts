...
type SkillUiMode = 'PLAIN_CHAT' | 'WORKSPACE'
type SkillPromptScene = 'CHAT' | 'PLANNER'
...
interface PublicSkillPromptTemplate {
  id: string
  skillId: string
...
interface PublicSkillWorkflowTemplate {
  id: string
  skillId: string
...
const applyPublicSkillCatalog = (skills?: PublicAgentSkillCatalogItem[]) => {
