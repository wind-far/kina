...
import type { CanvasConnection, CanvasNodeData, CanvasNodeMetadata } from "@infinite/types/canvas";
import type { CanvasResourceKind } from "@infinite/lib/canvas/canvas-resource-references";
