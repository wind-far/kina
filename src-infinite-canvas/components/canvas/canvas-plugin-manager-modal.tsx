...
import { installPluginFromUrl, setPluginEnabled, uninstallPlugin, updatePlugin } from "@infinite/lib/canvas/plugin-loader";
import { fetchOfficialPlugins, hasUpgrade, type OfficialPluginEntry } from "@infinite/lib/canvas/plugin-registry";
import { useThemeStore } from "@infinite/stores/use-theme-store";
import { usePluginStore, type InstalledPlugin } from "@infinite/stores/canvas/use-plugin-store";
