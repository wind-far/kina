...
import type { TActionWithOptionalArgs } from "@cutia/lib/actions";
import { getDefaultShortcuts } from "@cutia/lib/actions";
import { isTypableDOMElement } from "@cutia/utils/browser";
import { isAppleDevice } from "@cutia/utils/platform";
import type { KeybindingConfig, ShortcutKey } from "@cutia/types/keybinding";
import {
	runMigrations,
	CURRENT_VERSION,
