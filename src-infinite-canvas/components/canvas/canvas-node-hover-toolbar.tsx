...
import { Download, Ellipsis, FolderPlus, Image as ImageIcon, Info, Link2, MessageSquare, Minus, Music2, Pencil, Plus, RefreshCw, Settings2, Trash2, Upload, Video } from "lucide-react";
...
import { formatBytes, getDataUrlByteSize } from "@infinite/lib/image-utils";
import { useCopyText } from "@infinite/hooks/use-copy-text";
import { useThemeStore } from "@infinite/stores/use-theme-store";
import { CanvasNodeType, type CanvasNodeData, type ViewportTransform } from "@infinite/types/canvas";
import type { CanvasNodeToolbarItem } from "@infinite/types/canvas-plugin";
...
type CanvasNodeHoverToolbarProps = {
    ...
    onRecoverVideo: (node: CanvasNodeData) => void;
...
export function CanvasNodeHoverToolbar({
    ...
    const nodeToolbarTools: ToolbarTool[] = [
        ...
        ...(isVideo && canRetry ? [{ id: "recoverVideo", title: "使用已有 URL 恢复预览", label: "恢复预览", icon: <Link2 className="size-4" />, onClick: () => onRecoverVideo(node) }] : []),
