...
import { NODE_SPECS } from "@infinite/constant/canvas";
import { registerNodeDefinitions } from "@infinite/lib/canvas/node-registry";
import { CanvasNodeType, type CanvasNodeData } from "@infinite/types/canvas";
import type { CanvasNodeDefinition, CanvasNodeResource } from "@infinite/types/canvas-plugin";
